...
class TransactionFilterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<TransactionFilterPageController>();
    ...
    return Obx(
      () => Scaffold(
        appBar: AppBar(
          title: Text(
            translation.appTransactionFilterPageTitle.tr,
            style:
              ...
              itemBuilder: (context) {
                return [
                  PopupMenuItem(
                    ...
                    child:
                        const Text("Excel"), //translation.appPopupMenuDetailText.tr),
                  ),
              ...
              : controller.filteredTransactions.isNotEmpty
                  ? ListView.separated(
                      ...
                      separatorBuilder: (BuildContext context, int index) {
                        ...
                        // } else if (controller.filteredTransactions.length -
                        //         1 ==
                        //     index) {
                        //   return AppAdManager().getBannerAd();
                        // }
                  ...
                  : Container(
                      child: Center(
                        child: Text(translation
                            .userTransactionNoTransactionFoundText.tr),
                      ),
                    ),
        ),
      ),

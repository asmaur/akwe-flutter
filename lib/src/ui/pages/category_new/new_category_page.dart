...
class NewCategoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final NewCategoryPageController controller =
        Get.find<NewCategoryPageController>();

    return Scaffold(
      appBar: AppBar(
        title: Text(
          translation.userCategoryNewCategoryPageTitle.tr,
  ...
  loadIconSheet(NewCategoryPageController controller) {
    return Container(
      height: AppLayout.getScreenHeight() * .5,

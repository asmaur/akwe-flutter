...
import 'goal_page_view_controller.dart';

class GoalPageView extends StatelessWidget {
  GoalPageView({super.key});
  final controller = Get.put(GoalPageViewController());
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(translation.appDrawerGoalText.tr, style: Theme
              .of(context)
              .textTheme
              .titleSmall
          ...
          bottom: TabBar(
            tabs: [
              Tab(
                child: Text(translation.appActiveButtonLabel.tr,
                  style: Theme.of(context).textTheme.labelMedium?.copyWith(fontSize: 16),
                ),
              ),
              Tab(
                child: Text(translation.appArchivedButtonLabel.tr, style: Theme.of(context).textTheme.labelMedium?.copyWith(fontSize: 16),),
              ),
            ],
          ),
        ),
